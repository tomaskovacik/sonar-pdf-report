...
@Properties({
		...
		@Property(key = PDFPostJob.REPORT_TYPE, name = "Report Type", description = "Output format for the report. Allowed values: pdf, html. Default: pdf.", defaultValue = PDFPostJob.REPORT_TYPE_DEFAULT_VALUE, global = true, project = true, type = PropertyType.STRING),
